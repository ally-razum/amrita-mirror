...
// import ClientCardAdminView from '../clientCard/clientCardAdmit/clientCardAdminView';
...
function ClientTableUnReadyTorsunov (): JSX.Element {
...
//гетаем все карточки
  useEffect(() => {
    const fetchClients = async () => {
      try {
        const response = await client.get('/client/list/unready');
...
export default ClientTableUnReadyTorsunov;
