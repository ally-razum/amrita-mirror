...
function ClientTable(){
  ...
  // const confirmDelete = (client: Card) => {
          ...
          <Table stickyHeader sx={{ minWidth: "80%" }}>
            ...
            <TableBody>
              {mockCards.map((client) => (
                <TableRow
                  key={`${client.cardUser_Id}-${client.id}`}
                  sx={{
                ...
                >
                  {selectedColumns.includes("cardDBID") && (
                    <TableCell>{`AP-${client.id}`}</TableCell>
                  )}
                  ...
                  {selectedColumns.includes("cardClientNumber") && (
                    <TableCell>{client.cardClientNumber}</TableCell>
                  )}
                  {selectedColumns.includes("cardBasicDiagnosis") && (
                    <TableCell>{client.cardBasicDiagnosis}</TableCell>
                  )}
